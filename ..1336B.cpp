...
// basically optmize for x<=y<=z with upper and lower bound.
// upper bound returns the last occurence of a number strcilty greater than value;
// lower bound returns first occurence of a number strictly NOT LESS than value.
// if not found, lower bound returns last value;
// if not found, upper bound returns first value;
